...
#ifndef HRUN_hermes_encoder_trait_H_
#define HRUN_hermes_encoder_trait_H_

#include "hermes_encoder_trait_tasks.h"

namespace hermes::traits::encoder_trait {

/** Create hermes_encoder_trait requests */
...
#endif  // HRUN_hermes_encoder_trait_H_
